...
export const sidebarItems = [
  { icon: Home, label: 'Overview', path: '/', key: 'overview' },
  { icon: BookOpen, label: 'Courses', path: '/', key: 'courses' },
  { icon: Calendar, label: 'Planning', path: '/planning', key: 'planning' },
  { icon: BarChart3, label: 'Statistics', path: '/statistics', key: 'statistics' },
];
